                        ...
                        <div className="about-me pt-4 pt-md-0">
                          ...
                          {/*   <p className="lead">
                           ...
                           {/*  <p className="lead">
                            ...
                            <p className="lead">
                            Over the years, I've honed my skills in Angular, React, and PHP, and I'm always eager to learn and adapt to new technologies and frameworks.
                            I enjoy working collaboratively with designers and stakeholders to create stunning interfaces.
                            </p>
                            <p className="lead">
